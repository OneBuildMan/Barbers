    ...
    <Drawer anchor="right" open={p.open}>
      ...
      <div className={styles.menu}>
        <div className={styles.list}>
          ...
          <MenuButton variant="contained" color="primary" route="/barber-registration" onClick={p.closeDrawer}>
            Are you a barber?
          </MenuButton>
          <MenuButton variant="contained" color="primary" route="/reservation" onClick={p.closeDrawer}>
            Make a reservation
          </MenuButton>
          <MenuButton variant="contained" color="primary" route="/barbers" onClick={p.closeDrawer}>
            The Barbers
          </MenuButton>
